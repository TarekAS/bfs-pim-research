...
all:
	...
	gcc --std=c99 bfs-dpu/host/app.c -D "_POSIX_C_SOURCE=2" -DNR_TASKLETS=$(NR_TASKLETS) -DBLOCK_SIZE=$(BLOCK_SIZE) -DBENCHMARK_CYCLES=$(BENCHMARK_CYCLES) -o bin/bfs -lm `dpu-pkg-config --cflags --libs dpu`
